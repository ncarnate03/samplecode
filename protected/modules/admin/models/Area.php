...
class Area extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('speciality_id, status', 'numerical', 'integerOnly' => true),
            ...
            array('id, title, description, speciality_id, status, created_on, created_by, modified_on, modified_by', 'safe', 'on' => 'search'),
        );
    }
